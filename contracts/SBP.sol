...
contract SBP is BurnableToken, DetailedERC20, ERC20Token, TokenLock {
  using SafeMath for uint256;
  ...
  string public constant name = "Sound Blockchain Protocol";
  string public constant note = "Sound Blockchain Protocol is Music & entertainment contents platform and mobile payment and smart contract to interact with decentralized applications that run on the Klaytn Network";
